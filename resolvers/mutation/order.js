  ...
  async postorder(parent, args, ctx, info) {
    ...
    var HotelMsgData = {
      ...
      content: {
        ...
        keyword2: date.getFullYear()+'年'+ (date.getMonth()+1) +'月'+date.getDate()+'日'+date.getHours()+'时'+date.getMinutes()+'分开始' + ' ' + occupation,
  ...
  async modifyptoforder(parent, args, ctx, info) {
    try {
      ...
      if (args.ptstatus == 2) {
          ...
          num: 2,
          content: {
            keyword1: date.getFullYear()+'年'+(date.getMonth()+1) +'月'+date.getDate()+'日'+date.getHours()+'时'+date.getMinutes()+'分开始' + ' ' + occupation,
